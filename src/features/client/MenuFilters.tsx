...
interface MenuFiltersProps {
  ...
  /** offset superior para el sticky (altura de la barra que tenga encima) */
  topClassName?: string
}

export function MenuFilters({ category, onCategory, query, onQuery, topClassName = 'top-[52px]' }: MenuFiltersProps) {
  return (
    <div className={`sticky ${topClassName} z-30 border-b border-stone-200 bg-stone-100/95 backdrop-blur`}>
